...
namespace TotalImage.FileSystems.FAT
{
    ...
    public struct DirectoryEntry
    {
        ...
        {
            if (fat.BiosParameterBlock.RootDirectoryFirstCluster is not null)
            {
                return EnumerateSubdirectory(fat, fat.BiosParameterBlock.RootDirectoryFirstCluster.Value, includeDeleted);
            }
