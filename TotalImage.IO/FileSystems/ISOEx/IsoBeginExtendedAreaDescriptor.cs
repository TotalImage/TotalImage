...
namespace TotalImage.FileSystems.ISOEx
{
    ...
    /// </summary>
    public class IsoBeginExtendedAreaDescriptor : IsoVolumeDescriptor
    {
        /// <summary>
        /// The standard ISO 13490 Begin Extended Area identifier (BEA01)
        /// </summary>
        public static ImmutableArray<byte> StandardIdentifier { get; } = (new byte[] { 0x42, 0x45, 0x41, 0x30, 0x31 }).ToImmutableArray();
        ...
        public IsoBeginExtendedAreaDescriptor(in byte type, in ImmutableArray<byte> identifier, in byte version)
