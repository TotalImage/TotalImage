    ...
    public partial class frmMain : Form
    {
        ...
        private void UpdateStatusBar()
        {
            ...
            else
            {
                ...
                if (Convert.ToInt32(FreeSpacePercentage.Substring(0, FreeSpacePercentage.Length - 4)) <= 20)
                ...
                lblStatusProgressBar.Minimum = Convert.ToInt32(FreeSpacePercentage.Substring(0, FreeSpacePercentage.Length - 4));
                lblStatusProgressBar.Value = Convert.ToInt32(FreeSpacePercentage.Substring(0, FreeSpacePercentage.Length - 4));
