...
namespace TotalImage
{
    public partial class dlgImageInfo : Form
    {
        ...
        private void dlgImageInfo_Load(object sender, System.EventArgs e)
        {
            ...
            lstProperties.FindItemWithText("File size").SubItems[1].Text = Settings.CurrentSettings.SizeUnits.FormatSize((ulong)mainForm.image.Length, true);
            ...
            lstProperties.FindItemWithText("Total storage capacity").SubItems[1].Text = Settings.CurrentSettings.SizeUnits.FormatSize((ulong)mainForm.image.PartitionTable.Partitions[mainForm.CurrentPartitionIndex].Length);
        }
    }
}